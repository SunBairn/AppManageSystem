...
CREATE TABLE `ad_promotion` (
  ...
  `adPicPath` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '广告图片存储路径',
...
CREATE TABLE `app_category` (
  `id` bigint(30) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `category_code` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '分类编码',
  `category_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '分类名称',
  `parent_id` bigint(30) DEFAULT NULL COMMENT '父级节点id',
...
CREATE TABLE `app_info` (
  `id` bigint(30) NOT NULL AUTO_INCREMENT COMMENT '主键id',
  `software_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '软件名称',
  `apk_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'APK名称（唯一）',
  `support_rom` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '支持ROM',
  `interface_language` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '界面语言',
  `software_size` decimal(20,2) DEFAULT NULL COMMENT '软件大小（单位：M）',
  `update_date` date DEFAULT NULL COMMENT '更新日期',
  `dev_id` bigint(30) DEFAULT NULL COMMENT '开发者id（来源于：dev_user表的开发者id）',
  `app_info` varchar(5000) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '应用简介',
  `status` bigint(30) DEFAULT NULL COMMENT '状态（来源于：data_dictionary，1 待审核 2 审核通过 3 审核不通过 4 已上架 5 已下架）',
  `onsale_date` datetime DEFAULT NULL COMMENT '上架时间',
  `offsale_date` datetime DEFAULT NULL COMMENT '下架时间',
  `flatform_id` bigint(30) DEFAULT NULL COMMENT '所属平台（来源于：data_dictionary，1 手机 2 平板 3 通用）',
  `category_level3` bigint(30) DEFAULT NULL COMMENT '所属三级分类（来源于：data_dictionary）',
  `downloads` bigint(30) DEFAULT NULL COMMENT '下载量（单位：次）',
  `created_by` bigint(30) DEFAULT NULL COMMENT '创建者（来源于dev_user开发者信息表的用户id）',
  `creation_date` datetime DEFAULT NULL COMMENT '创建时间',
  `modify_by` bigint(30) DEFAULT NULL COMMENT '更新者（来源于dev_user开发者信息表的用户id）',
  `modify_date` datetime DEFAULT NULL COMMENT '最新更新时间',
  `category_level1` bigint(30) DEFAULT NULL COMMENT '所属一级分类（来源于：data_dictionary）',
  `category_level2` bigint(30) DEFAULT NULL COMMENT '所属二级分类（来源于：data_dictionary）',
  `logopic_path` varchar(500) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'LOGO图片url路径',
  `logoloc_path` varchar(500) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'LOGO图片的服务器存储路径',
  `version_id` bigint(30) DEFAULT NULL COMMENT '最新的版本id',
  PRIMARY KEY (`id`)
...
-- Records of app_info
-- ----------------------------
INSERT INTO `app_info` VALUES ('49', 'LBE安全大师', 'com.lbe.security', '2.2及更高版本', '简体中文', '9.00', null, '1', '欢迎您使用LBE安全大师，Android平台上首款主动式防御软件，第一款具备实时监控与拦截能力的安全软件。安全大师基于业界首创的API拦截技术，能够实时监控与拦截系统中的敏感操作，动态拦截来自已知和未知的各种威胁。避免各类吸费软件，广告软件乃至木马病毒窃取您手机内的隐私信息以及可能产生的经济损失。安全大师同时提供了强大的定制功能与完善的提示机制，您更可以精确控制系统中每一个应用的权限，同时不放过任何一次可疑的操作。对于没有获取root权限的用户，您依旧可以使用我们的流量控制，电话短信防火墙，系统优化清理等功能。', '1', null, null, '1', '32', '2000', '1', '2016-08-22 11:47:11', null, null, '1', '3', null, null, null);
INSERT INTO `app_info` VALUES ('50', '应用锁:Smart App Protector', 'com.sp.protector.free', '2.3及更高版本', '简体中文', '3.00', null, '1', 'Smart App Protector是一款应用锁定程序，可以实现当您打开某个应用时进行密码保护，从而保护用户的隐私问题。', '1', null, null, '1', '32', '5000', '1', '2016-08-22 11:49:12', null, null, '1', '3', '/AppInfoSystem/statics/uploadfiles/com.sp.protector.free.jpg', 'D:\\soft\\apache-tomcat-7.0.41\\webapps\\AppInfoSystem\\statics\\uploadfiles\\com.sp.protector.free.jpg', null);
INSERT INTO `app_info` VALUES ('51', '谷歌拼音输入法', 'com.google.android.inputmethod.pinyin', '4.2及更高版本', '简体中文', '16.00', null, '1', '谷歌拼音输入法是一款专门用于输入中文的输入法，提供了多种方便的输入方式：\r\n- 全键盘拼音支持中文滑行输入和智能纠错\r\n- 9键键盘拼音支持中文滑行输入\r\n- 笔画键盘\r\n- 全屏和半屏手写键盘\r\n- 英文键盘\r\n- 模糊拼音\r\n- 双拼\r\n- 针对各种不同屏幕尺寸优化的UI布局\r\n- 语音输入\r\n不仅支持输入简体中文、繁体中文，还支持标点符号、表情符号、拉丁字符和数字。语音输入法使用基于互联网的语音识别服务，以提供高精度的输入匹配。\r\n\r\n注意：要在你的Android设备上使用该输入法，请在 “设置”→“语言和输入法”中开启。\r\n\r\n如需输入粤语，请下载谷歌粤语输入法\r\nhttps://play.google.com/store/apps/details?id=com.google.android.apps.inputmethod.cantonese\r\n\r\n如需使用注音或者倉頡输入繁体中文，请下载谷歌注音输入法\r\nhttps://play.google.com/store/apps/details?id=com.google.android.apps.inputmethod.zhuyin', '2', null, null, '3', '29', '8000', '1', '2016-08-22 11:53:23', null, null, '1', '3', '/AppInfoSystem/statics/uploadfiles/com.google.android.inputmethod.pinyin.jpg', 'D:\\soft\\apache-tomcat-7.0.41\\webapps\\AppInfoSystem\\statics\\uploadfiles\\com.google.android.inputmethod.pinyin.jpg', '37');
INSERT INTO `app_info` VALUES ('52', 'RE管理器:Root Explorer', 'com.speedsoftware.rootexplorer', '2.3及更高版本', '简体中文', '3.00', null, '1', 'RootExplorer 需要 ROOT 权限，新建文件夹，查看 / 编辑文件，软件安装，RootExplorer 具备普通文件管理器的各项基本功能，另外还添加了搜索功能，在手机上找东西变得更加方便。此外，RootExplorer 最大的特点在于它能够删除手机中自带的应用程序，如 GOOGLEMAP,CONTACTS,MARKET,GTALK 等等。', '1', null, null, '1', '30', '2340', '1', '2016-08-22 11:55:14', null, null, '1', '3', '/AppInfoSystem/statics/uploadfiles/com.speedsoftware.rootexplorer.jpg', 'D:\\soft\\apache-tomcat-7.0.41\\webapps\\AppInfoSystem\\statics\\uploadfiles\\com.speedsoftware.rootexplorer.jpg', '38');
...
INSERT INTO `app_info` VALUES ('57', '机械世界:Apparatus', 'com.bithack.apparatus', '1.6及更高版本', '英文软件', '11.00', null, '1', '在机械世界Apparatus游戏中你需要利用木板、钉子、绳索、圆轮等等各种道具搭建从简单到复杂的机械结构，使得小球可以最终滚落到蓝色方框中。可以利用的可不止重力，包括杠杆原理、滑轮等等，尤其是后面的关卡，你需要足够灵活的头脑才能解决问题，可玩性还是非常高的。', '3', null, null, '1', '44', '255', '1', '2016-08-22 13:13:27', null, null, '2', '20', '/AppInfoSystem/statics/uploadfiles/com.bithack.apparatus.jpg', 'D:\\soft\\apache-tomcat-7.0.41\\webapps\\AppInfoSystem\\statics\\uploadfiles\\com.bithack.apparatus.jpg', '41');
INSERT INTO `app_info` VALUES ('58', '沙盘玩具:The Powder Toy', 'com.doodleapps.powdertoy', '2.2及更高版本', '英文软件', '1.00', null, '1', '沙盘玩具The Powder Toy是一款模拟类游戏。想过自己建造核电站吗？或者自己做一个CPU？你甚至可以创建一个虚拟网络。沙盘玩具可以模拟空气的压力，速度，热，重力和无数的不同物质之间的相互作用，游戏提供各种形态的建材，用以构建复杂的机器或是电子元件，你可以模拟超酷的爆炸或是布线出复杂的机器人。欢迎提交您的作品。', '4', null, '2016-08-22 13:27:42', '3', '44', '2000', '1', '2016-08-22 13:14:56', '1', null, '2', '20', '/AppInfoSystem/statics/uploadfiles/com.doodleapps.powdertoy.jpg', 'D:\\soft\\apache-tomcat-7.0.41\\webapps\\AppInfoSystem\\statics\\uploadfiles\\com.doodleapps.powdertoy.jpg', '40');
INSERT INTO `app_info` VALUES ('87', '雷霆战机', 'com.zls.leitingzhanji', '2.3以及更高版本', '简体中文', '40.00', null, '1', '很好玩', '1', null, null, '1', null, null, '1', '2019-06-02 05:44:40', null, null, '2', '23', null, null, null);
INSERT INTO `app_info` VALUES ('155', '发生的风格', '二分法', null, null, '40.00', null, '1', null, '1', null, null, '2', null, null, '1', '2019-06-02 11:12:10', null, null, null, null, null, null, null);
INSERT INTO `app_info` VALUES ('157', '王者荣耀', 'com.lbe.security.wangzherongyao', '6.0及更高版本', '中文', '1500.00', null, '1', '王者荣耀是一个不错的游戏', '1', null, null, '1', '41', null, '1', '2019-06-17 13:00:12', null, null, '2', '19', null, null, null);
...
CREATE TABLE `app_version` (
  `id` bigint(30) NOT NULL AUTO_INCREMENT COMMENT '主键id',
  `app_id` bigint(30) DEFAULT NULL COMMENT 'appId（来源于：app_info表的主键id）',
  `version_no` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '版本号',
  `version_info` varchar(2000) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '版本介绍',
  `publish_status` bigint(30) DEFAULT NULL COMMENT '发布状态（来源于：data_dictionary，1 不发布 2 已发布 3 预发布）',
  `download_link` varchar(500) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '下载链接',
  `version_size` decimal(20,2) DEFAULT NULL COMMENT '版本大小（单位：M）',
  `created_by` bigint(30) DEFAULT NULL COMMENT '创建者（来源于dev_user开发者信息表的用户id）',
  `creation_date` datetime DEFAULT NULL COMMENT '创建时间',
  `modify_by` bigint(30) DEFAULT NULL COMMENT '更新者（来源于dev_user开发者信息表的用户id）',
  `modify_date` datetime DEFAULT NULL COMMENT '最新更新时间',
  `apkloc_path` varchar(500) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'apk文件的服务器存储路径',
  `apk_fileName` varchar(500) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '上传的apk文件名称',
  PRIMARY KEY (`id`)
...
CREATE TABLE `data_dictionary` (
  `id` bigint(30) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `type_code` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '类型编码',
  `type_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '类型名称',
  `value_id` bigint(30) DEFAULT NULL COMMENT '类型值ID',
  `value_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '类型值Name',
  `created_by` bigint(30) DEFAULT NULL COMMENT '创建者（来源于backend_user用户表的用户id）',
  `creation_date` datetime DEFAULT NULL COMMENT '创建时间',
  `modify_by` bigint(30) DEFAULT NULL COMMENT '更新者（来源于backend_user用户表的用户id）',
  `modify_date` datetime DEFAULT NULL COMMENT '最新更新时间',
...
-- Records of dev_user
-- ----------------------------
INSERT INTO `dev_user` VALUES ('1', 'root', '测试账户001', '123', null, null, '1', '2019-06-06 00:13:41', null, null);
